...
class Principall(QtGui.QWidget):
    def __init__(self, parent=None):
        QtGui.QWidget.__init__(self, parent)


        self.setGeometry(0, 0, 1920, 1080)
        self.setWindowTitle('Luminosidad')
        ...
        quit.setIcon(QtGui.QIcon('luminosidad_boton_inicio.png'))
        ...
        self.label.setPixmap(QtGui.QPixmap(os.getcwd() + "/luminosidad_header.png"))

        self.labe = QtGui.QLabel(self)
        self.labe.setGeometry(0, 430, 303, 403) #740
        self.labe.setPixmap(QtGui.QPixmap(os.getcwd() + "/luminosidad_sensor.png"))

        self.label11 = QtGui.QLabel(self)
        self.label11.setGeometry(1020, 160, 890, 863) #1000
        self.label11.setPixmap(QtGui.QPixmap(os.getcwd() + "/luminosidad_cuadro1.png"))

        self.label1 = QtGui.QLabel(self)
        self.label1.setGeometry(1095, 230, 770, 800) #1195
        self.label1.setStyleSheet("font-size:35px;font-family: Verdana;color:#000000")
        self.label1.setText(u"Se llama  a la parte de la radiación \nelectromagnética que puede ser percibida \npor el ojo humano. La refracción es el \ncambio brusco de dirección que sufre la \nluz al cambiar de medio.\n\nLa luminosidad, tambien llamada claridad, \nes una propiedad de los colores. Ella da \nuna indicación sobre el aspecto luminoso \ndel color estudiado: cuanto más oscuro es \nel color, la luminosidad es mas débil.\n\nEl lumen (simbolo: lm) es la unidad del \nSistema Internacional de Medidas para \nmedir el flujo luminoso, una medida de \nla potencia luminosa emitida por la fuente \nde luz, por ejemplo un bombillos.")

        self.label22 = QtGui.QLabel(self)
        self.label22.setGeometry(3080, 530, 770, 580) #1160
        self.label22.setPixmap(QtGui.QPixmap(os.getcwd() + "/luminosidad_cuadro_2.png"))
        
                
        self.label33 = QtGui.QLabel(self)
        self.label33.setGeometry(2510, 570, 600, 500)#560
        self.label33.setPixmap(QtGui.QPixmap(os.getcwd() + "/Luminosidad_fondo_contador.png"))
        
        
        self.label3 = QtGui.QLabel(self)
        self.label3.setGeometry(60, 720, 1000, 290) #630
        self.label3.setText(u"Mueva la mano sobre el sensor de luz y \nobserve las variaciones de intensidad.")
        self.label3.setStyleSheet("font-size:40px;color:#000000")
       
        
        self.foton = QtGui.QLabel(self)
        self.foton.setGeometry(165, 550, 1300, 200) #200
        self.foton.setStyleSheet("font-size:58px;font-family: Verdana;color:#000000")
        self.foton.setText('(Lumens) Flujo Luminoso (lm)')
